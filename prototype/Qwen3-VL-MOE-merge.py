...
KV_RENAMES = {
    "clip.vision.block_count":                  "qwen3vlmoe.vision.block_count",
    "clip.vision.embedding_length":             "qwen3vlmoe.vision.embedding_length",
    #"clip.vision.feed_forward_length":          "qwen3vl.vision.feed_forward_length",
    "clip.vision.attention.head_count":         "qwen3vlmoe.vision.attention.head_count",
    "clip.vision.attention.layer_norm_epsilon": "qwen3vlmoe.vision.attention.layer_norm_epsilon",
    "clip.vision.patch_size":                   "qwen3vlmoe.vision.patch_size",
    "clip.vision.image_size":                   "qwen3vlmoe.vision.image_size",
    "clip.vision.spatial_merge_size":           "qwen3vlmoe.vision.spatial_merge_size",
    "clip.vision.image_mean":                   "qwen3vlmoe.vision.image_mean",
    "clip.vision.image_std":                    "qwen3vlmoe.vision.image_std",
...
OFFICIAL_BLOB = "/var/lib/ollama/blobs/sha256-b1da6f96a2e40e5db05b6066d799c69411225b336bfa20ef1b002c223ed4b190"
#"/var/lib/ollama/blobs/sha256-ed12a4674d727a74ac4816c906094ea9d3119fbea46ca93288c3ce4ffbe38c55"
...
mmproj = GGUFReader("Jan-v2-VL-max-FP8-mmproj.gguf")
vision_tensors = {}
...
# === OUTPUT GENERATION ===
llm = GGUFReader("Jan-v2-VL-max-FP8.gguf") #qwen3vl-llm.gguf")
writer = GGUFWriter("jan-v2-vl-merged.gguf", arch="qwen3vlmoe")
...
writer.add_uint32("qwen3vlmoe.vision.num_channels", 3)
writer.add_uint32("qwen3vlmoe.vision.temporal_patch_size", 2)
writer.add_uint32("qwen3vlmoe.vision.num_positional_embeddings", 2304)
writer.add_float32("qwen3vlmoe.vision.rope.freq_base", 10000.0)
#writer.add_uint32("qwen3vl.vision.shortest_edge", 65536)
#writer.add_uint32("qwen3vl.vision.longest_edge", 16777216)
writer.add_array("qwen3vlmoe.mrope_sections", [24, 20, 20])
writer.add_array("qwen3vlmoe.vision.deepstack_visual_indexes", [8, 16, 24])
...
writer.add_uint32("qwen3vlmoe.vision.shortest_edge", 65536)     # Jan native
...
#final_progress = tqdm(total=3, desc="Finalize Output", unit="step", position=0, leave=True)
# Finalize output
